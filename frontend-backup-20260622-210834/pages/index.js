            ...
            {[
              {
                ...
                desc: "Type in your website address — any platform works.",
              },
              {
                step: "02",
                title: "Automated scan",
                desc: "We run 8 AI readiness checks against your site in real time.",
              },
              {
                step: "03",
                title: "Get your report",
                desc: "Receive a detailed score with actionable fixes for each issue.",
              },
            ].map((item) => (
