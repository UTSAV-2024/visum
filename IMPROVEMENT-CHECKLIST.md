...
- [ ] Retire the old Python-runtime Render service (`visum`, `visum-xoe3.onrender.com`) once the frontend has been redeployed against the new backend — **requires the user** (destructive; also frees free-tier instance hours)
